...
#include "stanExports_vector_model_cholesky.h"

RCPP_MODULE(stan_fit4vector_model_cholesky_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_vector_model_cholesky")
